...
import 'package:wonway/UI/pages/Recreteur/recru_connexion.dart';
import 'package:wonway/UI/pages/loobi.dart';

class RecruteurConnexionPage extends StatefulWidget {
  const RecruteurConnexionPage({super.key});

  @override
  State<RecruteurConnexionPage> createState() => _RecruteurConnexionPageState();
}

class _RecruteurConnexionPageState extends State<RecruteurConnexionPage> {
  ...
  final TextEditingController postectrl = TextEditingController();
                        ...
                        child: Column(
                          children: [
                            ...
                            TextFormField(
                              ...
                              validator: (value) =>
                                  value!.isEmpty ? "Entrez le nom de votre entreprise" : null,
                            ),
                            const SizedBox(height: 10),
